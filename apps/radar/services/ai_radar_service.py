...
class AIRadarService:
    ...
    def _check_youtube_synthetic_flag(cls, video_id, snippet=None, description='', topic_cats=None):
        """
        Detects YouTube's official Altered/Synthetic content disclosure.
        ...
        # Check for YouTube's standard disclosure text phrases
        ...
        # AI Engine specific presence
        is_suno = 'suno' in title_lower or 'suno' in desc_lower or '#sunoai' in desc_lower
        is_udio = 'udio' in title_lower or 'udio' in desc_lower or '#udio' in desc_lower

        if has_yt_disclosure:
            return True, 'YouTube Verified AI Flag', 99
        elif is_suno:
            ...
            return False, 'AI Music Release', 90

        return False, 'AI Track', 85
    ...
    def _apply_filters(cls, tracks, time_window='48h', duration_filter='all', popularity_filter='all', detection_mode='all'):
        ...
        for t in tracks:
            ...
            # 4. YouTube-Flagged Detection Mode Filter
